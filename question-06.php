...
<div>
    <div class="container-fluid bg-warning text-dark mt-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-10">
                    <!--***question title-->
                    <h1 id="questionTitle">Frage 6 von 15</h1>
                    <!--***question text-->
    ...
    <div class="container">
        ...
        <form action="question-07.php" method="post" onsubmit="return validateQuestion();">
            <div class="row">
                <div class="col-1"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <div>
                            ...
                            <input type="hidden" name="lastPageID" value="question-06">
